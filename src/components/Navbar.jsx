export default function Navbar({ tab, setTab, session, isHR, onSignOut }) {
  ...
  return (
    <nav style={{ background: "#0f172a", color: "white", position: "sticky", top: 0, zIndex: 100 }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "16px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
