...
export default function ApplyForm({ onSuccess, refreshData, initialJobId }) {
  ...
  const runFakeAI = async () => {
    ...
    const summaries = [
      ...
      "Solid candidate profile. Technical skills align well with the role requirements.",
    ...
    <div style={{ maxWidth: "920px", margin: isMobile ? "16px auto" : "40px auto", padding: "0 12px" }}>
      <div style={{ background: "#ffffff", padding: isMobile ? "24px 16px" : "48px 40px", borderRadius: isMobile ? "14px" : "20px", boxShadow: "0 10px 40px rgba(0,0,0,0.08)" }}>
        <div style={{ textAlign: "center", marginBottom: isMobile ? "24px" : "40px" }}>
          ...
          <p style={{ color: "#64748b", fontSize: isMobile ? "0.9rem" : undefined }}>Chilanga Cement PLC • Careers</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <section style={{ marginBottom: 32 }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <textarea name="skills" value={form.skills} rows={3} onChange={handleChange} style={input} placeholder="e.g. AutoCAD, Excel, Leadership..." />
            </div>
            <div>
